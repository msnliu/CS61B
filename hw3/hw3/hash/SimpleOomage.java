// https://sp19.datastructur.es/materials/hw/hw3/hw3
// Note that it is generally necessary to override the hashCode method whenever the equals method is overridden
...
public class SimpleOomage implements Oomage {
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            // problem is red, green, and blue are always multiple of 5, if divided by 10, the remainder will be either 0 or 5
            // divide the red, green, and blue values by 5 before computing the hash code
